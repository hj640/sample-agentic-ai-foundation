...
resource "aws_codecommit_repository" "frontend" {
  ...
  description     = "Frontend repository for ${var.project_name}"
...
resource "aws_codebuild_project" "frontend" {
  ...
  description   = "Build project for ${var.project_name} frontend"
  ...
  source {
    ...
    git_clone_depth = 1
    buildspec       = "cx-agent-react/buildspec.yml"
  }
...
# CloudWatch Events Rule for CodeCommit Push
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = aws_codecommit_repository.frontend.arn
      },
      {
        Effect = "Allow"
        Action = [
